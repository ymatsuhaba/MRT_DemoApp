...
<form action="/yukiLab" method="update" class="form-horizontal">
    ...
    <div class="form-group @if($errors->has('release_date')) has-error @endif">
        ...
        <div class="col-sm-9">
            <input type="date" class="form-control" id="release_date" name="release_date" min="2019-07-01" max="2019-07-31" value="{{$yucky_books->release_date}}">
    ...
    <div class="form-group @if($errors->has('lending_situation')) has-error @endif">
        ...
        <div class="col-sm-9">
            <input class="form-check-input" type="checkbox" name="lending_situation[]" value=0 {{in_array("0",$yucky_books->lending_situation)?"checked":""}}>貸出中
            <input class="form-check-input" type="checkbox" name="lending_situation[]" value=1 {{in_array("1",$yucky_books->lending_situation)?"checked":""}}>在庫あり
            <input class="form-check-input" type="checkbox" name="lending_situation[]" value=2 {{in_array("2",$yucky_books->lending_situation)?"checked":""}}>紛失中
