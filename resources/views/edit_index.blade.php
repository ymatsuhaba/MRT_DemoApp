        ...
        <div class="col-md-3">
            ...
            <form action="{{url('/edit_confirm')}}" method="post" class="form-horizontal">
                ...
                <div class="form-group @if($errors->has('doctor_name')) has-error @endif">
                    <label>名前</label>
                    @if(empty($errors)){<input type='text' name='doctor_name' value="{{$doctor->doctor_name}}">}
                    @else(<input type='text' name='doctor_name'value='{{ old('doctor_name') }}'>)@endif
                ...
                <div class="form-group @if($errors->has('birthplace')) has-error @endif">
                    ...
                    @if($errors->has('birthplace'))<input type='hidden' name='birthplace' value='{{ old('birthplace') }}'><span class="text-danger">{{ $errors->first('birthplace') }}</span> @endif
                </div>
                <br>
                <br>
                <div class="form-group @if($errors->has('sex')) has-error @endif">
                    ...
                    @if($errors->has('sex'))<input type='hidden' name='sex' value='{{ old('sex') }}'><span class="text-danger">{{ $errors->first('sex') }}</span> @endif
                </div>
                <br>
                <br>
                <div class="form-group @if($errors->has('date_of_birth')) has-error @endif">
                    ...
                    @if($errors->has('date_of_birth'))<input type='hidden' name='date_of_birth' value='{{ old('date_of_birth') }}'><span class="text-danger">{{ $errors->first('date_of_birth') }}</span> @endif
                </div>
                <br>
                <br>
